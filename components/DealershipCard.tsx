  ...
  return (
    ...
    >
      <div className="p-4">
        ...
        {/* Row 4: Metadata — nowrap single line; Onb/Live stay right of Grp/ERA/PP/St/Br */}
        <div className="flex items-center gap-x-5 whitespace-nowrap overflow-hidden text-xs text-slate-500 dark:text-slate-400 pt-2 border-t border-slate-200/40 dark:border-[#38383A]/50">
          <span className="flex items-center gap-1.5 flex-shrink-0" title="Group">
            <span className="font-medium text-slate-400 dark:text-slate-500">Grp:</span>
            <span className="font-mono">{groupName || 'Single'}</span>
          </span>

          <span className="flex items-center gap-1.5 flex-shrink-0" title="ERA System ID">
          ...
          <span className="flex items-center gap-1.5 flex-shrink-0" title="PP System ID">
            <span className="font-medium text-slate-400 dark:text-slate-500">PP:</span>
            <span className="font-mono">{dealership.pp_sys_id || '--'}</span>
          </span>

          <span className="flex items-center gap-1.5 flex-shrink-0" title="Store Number">
          ...
          <span className="flex items-center gap-1.5 flex-shrink-0" title="Branch Number">
          ...
          <span className="flex items-center gap-1.5 flex-shrink-0 ml-auto" title="Onboarding Date">
          ...
          <span className="flex items-center gap-1.5 flex-shrink-0" title="Go Live Date">
